<!-- 此文件并非模版文件，请将其放置于plugin/duoshuo目录下 -->
<?php
...
<script type="text/javascript" src="wp-content/themes/Loostrive/js/embed.js" charset="UTF-8" async="async"></script>
<?php 
	}
...
(function() {
    ...
    ds.charset = 'UTF-8';
    ds.src = 'wp-content/themes/Loostrive/js/embed.js';
